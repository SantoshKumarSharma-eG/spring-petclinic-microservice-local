...
public class URIConstants {
	public static final String OWNER_URL = "http://localhost:4000";
	...
	public static final String PET_URL = "http://localhost:3000";
	public static final String CREATE_PET_HTML = "pets/createOrUpdatePetForm";
	
	public static final String VET_URL = "http://localhost:5000";
	...
	public static final String VISIT_URL = "http://localhost:6000";
