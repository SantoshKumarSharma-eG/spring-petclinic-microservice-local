...
class OwnerController {		
	...
	private boolean isDemo() {
		boolean demo = false;
		try {
			demo = Boolean.parseBoolean(System.getProperty("DEMO"));
	...
	private boolean isSlowSQLQueryEnabled() {
		...
		try {
			isSlowSQLQueryEnabled = Boolean.parseBoolean(System.getProperty("DEMO_SLOW_SQL_QUERY"));
	...
	private Double getSlowQueryMillis() {
		Double demoSQL = 0.01;
		demoSQL = Double.parseDouble(System.getProperty("DEMO_SLOW_SQL_QUERY_MILLIS"));
	...
	private String getExternalUrl(String defaultUrl) {
		...
		try {
			demoUrl = System.getProperty("DEMO_EXTERNAL_URL");
	...
	private boolean isExternalCallEnabled() {
		...
		try {
			String demoUrl = System.getProperty("DEMO_EXTERNAL_URL");
			if(demoUrl != null && demoUrl.length() > 0) {
	...
	private boolean isCpuCodeSlowEnabled() {
		...
		try {
			String demoCpu = System.getProperty("DEMO_CPU_MILLIS");
	...
	private Long getCpuMillis() {
		Long demoCpu = 5000L;
		demoCpu = Long.parseLong(System.getProperty("DEMO_CPU_MILLIS"));
